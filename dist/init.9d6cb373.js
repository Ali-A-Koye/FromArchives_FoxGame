...
const writeModal = function writeModal(text = "") {
  document.querySelector(".modal-inner").innerHTML = `<div class="modal-inner"> ${text}</div>`;
};
...
exports.getNextPoopTime = exports.getNextDieTime = exports.getNextHungerTime = exports.NIGHT_LENGTH = exports.DAY_LENGTH = exports.RAIN_CHANCE = exports.SCENES = exports.ICONS = exports.TICK_RATE = void 0;
...
const gameState = {
  ...
  startGame() {
    ...
    this.wakeTime = this.clock + 3; //9 sec to hatch
  ...
  clearTimes() {
    this.wakeTime = -1, this.sleepTime = -1, this.hungryTime = -1, this.dieTime = -1, this.poopTime = -1, this.timeToStartCelebrating = -1, this.timeToEndCelebrating = -1;
  },
  ...
  die() {
    ...
    (0, _ui.modFox)("dead");
    this.clearTimes();
    (0, _ui.writeModal)("the Fox Died :( Press the Middle Button to start ");
  },
